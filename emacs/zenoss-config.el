...
(defun zen-switch-to-sandbox ()
  "Will switch my Products to my sandbox (always checked out in dev/sandbox/Products) and will restart zope "
  (interactive)
  (shell-command "rm /Users/joseph/zenoss/zenoss/Products && ln -s /Users/joseph/dev/sandbox/Products/ /Users/joseph/zenoss/zenoss/Products")
  (restart-zope))

(defun zen-switch-to-trunk ()
  "Changes the zenoss/Products to trunk and restarts runzope"
  (interactive)
  (shell-command "rm /Users/joseph/zenoss/zenoss/Products && ln -s /Users/joseph/dev/Products/ /Users/joseph/zenoss/zenoss/Products")
  (restart-zope))